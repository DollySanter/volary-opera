...
import (
	...
	"github.com/DollySanter/volary-opera/eventcheck/bvallcheck"
	"github.com/DollySanter/volary-opera/eventcheck/epochcheck"
	"github.com/DollySanter/volary-opera/eventcheck/evallcheck"
	"github.com/DollySanter/volary-opera/eventcheck/heavycheck"
	"github.com/DollySanter/volary-opera/eventcheck/parentlesscheck"
	"github.com/DollySanter/volary-opera/evmcore"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockrecords/brprocessor"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockrecords/brstream"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockrecords/brstream/brstreamleecher"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockrecords/brstream/brstreamseeder"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockvotes/bvprocessor"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockvotes/bvstream"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockvotes/bvstream/bvstreamleecher"
	"github.com/DollySanter/volary-opera/gossip/protocols/blockvotes/bvstream/bvstreamseeder"
	"github.com/DollySanter/volary-opera/gossip/protocols/dag/dagstream"
	"github.com/DollySanter/volary-opera/gossip/protocols/dag/dagstream/dagstreamleecher"
	"github.com/DollySanter/volary-opera/gossip/protocols/dag/dagstream/dagstreamseeder"
	"github.com/DollySanter/volary-opera/gossip/protocols/epochpacks/epprocessor"
	"github.com/DollySanter/volary-opera/gossip/protocols/epochpacks/epstream"
	"github.com/DollySanter/volary-opera/gossip/protocols/epochpacks/epstream/epstreamleecher"
	"github.com/DollySanter/volary-opera/gossip/protocols/epochpacks/epstream/epstreamseeder"
	"github.com/DollySanter/volary-opera/gossip/protocols/snap/snapstream/snapleecher"
...
func (h *handler) handle(p *peer) error {
	...
	if p.RunningCap(ProtocolName, []uint{VLRY63}) {
