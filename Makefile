...
opera:
	...
	GOPROXY=$(GOPROXY) \
	go build \
	    -ldflags "-s -w -X github.com/DollySanter/volary-opera/cmd/opera/launcher.gitCommit=$${GIT_COMMIT} -X github.com/DollySanter/volary-opera/cmd/opera/launcher.gitDate=$${GIT_DATE}" \
	    -o build/opera \
	    ./cmd/opera
